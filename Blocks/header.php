<table border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
        <td width="100" align="left">
            <div class="dropdown">
                <a href="woman.php" class="nav-link">ЖЕНСКОЕ</a>
                <div class="dropdown-content">
                    <a href="/Outerwear.php">верхняя одежда</a>
                    <!-- <a href="#">джинсы</a>
                    <a href="#">свитеры и кардиганы</a>
                    <a href="#">обувь</a> -->
                    <a href="/dress.php">платья</a>
                    <!-- <a href="#">шапки</a> -->
                </div>
            </div>
        </td>
        <!-- <td width="100" align="left">
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="#">джинсы</a>
                    <a href="#">толстовки и худи</a>
                    <a href="#">обувь</a>
                    <a href="#">футболки и лонгсливы</a>
                    <a href="#">шапки</a>
                </div>
            </div>
        </td> -->
        <td width="150" align="center">
            <a href="index.php"><img src="Images/logo.jpg" alt="Логотип" align="center" width="75%" height="75%"></a>
        </td>
