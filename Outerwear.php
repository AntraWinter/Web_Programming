...
<html>
    ...
    <?php require_once "Blocks/header.php"; ?>
        ...
        <table border="0" width="1000" cellpadding="5" cellpaccing="0" align="center">
            <tr>
                <h1 align="center">женская верхняя одежда</h1>
                <td>
            ...
            <div class="product-gallery">
                <?php
                    ...
                    $pdo = new PDO('mysql:host=localhost;dbname=befree-website;port=3306', 'root', '');
                    ...
                    if (!empty($query)) {
                        ...
                        $sql = 'SELECT * FROM product WHERE category="женская верхняя одежда"';
                        $stmt = $pdo->prepare($sql);
                    }
                        ...
                        foreach ($products as $product) {
                            echo '
                                <div class="product" onclick="window.location.href=\'' . $product->article . '.php\'">
                                    <img src="Images/' . $product->image . '" alt="верхняя одежда" width="75%" height="75%">
                                    <h3>' . $product->price . '₽</h3>
